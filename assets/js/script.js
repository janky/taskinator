...
var taskFormHandler = function(event)
{
    ...
    //check if any input values are empty strings
    ...
    //no data attribute, so create object as normal and pass tp createTaskEl function
    else
    {
        //set data as on object
        var taskDataObj =
        {
            name: taskNameInput,
            type: taskTypeInput,
...
//form elements for each task
var createTaskActions = function(taskId)
{
    //create div element to contain forms
...
//create task button event handler
...
var editTask = function(taskId)
{
    ...
    //update form to display tasks to edit
...
// retrieve tasks and display on page
